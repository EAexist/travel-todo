...
export const ReservationConfirmFromTextScreen: FC<
  AppStackScreenProps<'ReservationConfirmFromText'>
> = () => {
          ...
          render={() => (
            <SectionCard>
              <ListItem>
                ...
                <ListItem.Content>
                  <ListItem.Title>{item.reservation.title}</ListItem.Title>
                  <ListItem.Subtitle>
              ...
              {item.reservation.category === 'ACCOMODATION' ? (
                <>
                  <ListItemBase
                    ...
                    title={
                      item.reservation.accomodation?.checkinDateTimeParsed ||
                      '-'
                    }
                  />
                  <ListItemBase
                    ...
                    title={
                      item.reservation.accomodation?.checkoutDateTimeParsed ||
                      '-'
                    }
                  />
                  {item.reservation.accomodation?.nightsParsed && (
                    <ListItemBase
                      avatarProps={{
                        icon: {
                          name: 'moon',
                      ...
                      title={item.reservation.accomodation?.nightsParsed}
                    />
                  )}
                </>
              ) : (
